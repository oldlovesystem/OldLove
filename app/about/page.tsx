                    ...
                    <div className="container">
                        <div className="text flex items-center justify-center">
                           <div className="content md:w-5/6 w-full">
                                ...
                                <div className="body1 text-center md:mt-7 mt-5">Welcome to OLDLOVE, where style meets comfort. Our journey began
...
essence of sophistication with OLDLOVE Menswear.</div>
                            </div>
                        </div>
