...
const AboutUs = () => {
    return (
        <>
            <div id="header" className='relative w-full font-tenor-sans'>
                ...
                <div className="about-us-block">
                    <div className="container flex flex-col md:flex-row items-center">
                        ...
                        <div className="content md:w-1/2 w-full md:pr-10">
                            <div className="heading3 text-center md:text-left font-tenor-sans uppercase md:text-2xl lg:text-3xl"> The Story of Oldlove</div>
